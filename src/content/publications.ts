...
export const publications: Publication[] = [
  {
    ...
    slug: "brushu",
    title:
      "BruSHŪ: Cross-Modal Translation of Implicit Micro-Actions in Chinese Calligraphy",
    authorList: [
      { name: "T. Liu", isMe: true, affiliations: [1, 2] },
      { name: "S. Zhang", affiliations: [1, 3] },
      { name: "N. Merendino", affiliations: [1] },
    ],
    affiliations: [
  ...
  },
  {
    ...
    title:
      "To Perform/ To Live: Decolonizing of Digital Music Instruments and Feminism with Human-AI Co-Created Embodied Experience of Daily Objects",
    authorList: [
      { name: "S. Zhang", affiliations: [1, 2] },
      { name: "S. Lin", affiliations: [1] },
      { name: "T. Liu", isMe: true, affiliations: [1, 3] },
      { name: "M. Fan", affiliations: [1, 4] },
      { name: "R. Masu", affiliations: [5, 1] },
    ],
    affiliations: [
      "The Hong Kong University of Science and Technology (Guangzhou)",
      "University of Trento",
